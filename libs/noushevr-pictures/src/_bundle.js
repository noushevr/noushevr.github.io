...
getByClass, getHumanDate, hasClass, imagesLoaded, imagesPreloaded, isNodejs,
isElectron, isNwjs, LazyLoad, loadDeferred, loadJsCss, manageDataSrcIframeAll,
manageDataSrcImgAll, manageExternalLinkAll, Masonry, needsPolyfills,
openDeviceBrowser, Packery, parseLink, PhotoSwipe, PhotoSwipeUI_Default,
QRCode, removeChildren, removeClass, require, scroll2Top, setDisplayBlock,
...
(function (root, document) {
	...
	var urlArray = ["../../libs/noushevr-pictures/css/bundle.min.css"];
