...
(function (root, document) {
	...
	var run = function () {
		...
		var initMasonry = function () {
			...
			var holder = document[getElementsByClassName]("holder-filter-buttons")[0] || "";
			var btn = holder ? holder[getElementsByTagName]("li") || "" : "";
			var sel = document[getElementsByClassName]("filter-select")[0] || "";
			var controls = document[getElementsByClassName]("holder-filter-controls")[0] || "";
			var iso;
			var msnry;
			var pckry;
	...
	var scripts = ["./libs/noushevr-sitemap/css/bundle.min.css"];
	...
	scripts.push("./libs/noushevr-sitemap/js/vendors.min.js");
